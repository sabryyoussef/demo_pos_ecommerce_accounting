...
(marked COMM-DEMO / generated source), never posted accounting or live orders.
    ...
    "data": [
        ...
        "data/demo_database/res_users.xml",
        "data/demo_database/hr_employee.xml",
        "data/demo_database/crm_team.xml",
        "data/demo_database/product_template.xml",
        "data/demo_database/product_product.xml",
        "data/demo_database/account_journal.xml",
        "data/demo_database/stock_location.xml",
        "data/demo_database/stock_picking_type.xml",
        "data/demo_database/pos_payment_method.xml",
        "data/demo_database/pos_config.xml",
        "data/demo_database/stock_quant.xml",
        "data/demo_database/sale_order.xml",
        "data/demo_database/sale_order_line.xml",
